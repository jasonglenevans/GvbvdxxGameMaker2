	...
	<body>
		...
		<div class="right">
			...
			<div class="RightContainerDiv">
				...
				<button onclick="document.getElementById('libary').hidden = false;document.getElementById('main_menu').hidden = true;" class="buttonBlue" style="margin-left:0px;margin-top:0px;">Add from libary</button>
		...
		<script src="ggm-gui/zip-export.js?n=1"></script>
		<script src="ggm-gui/jszip.min.js?n=1"></script>
